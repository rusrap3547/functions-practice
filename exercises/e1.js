...
function logMessageWithMyName(string) {
  console.log('My name is ', logMessageWithMyName)
}

logMessageWithMyName('Russ')
...
// Your code goes here...
function logMyInfo(string, number){
  console.log('My name is', string, 'I am', number, 'years old!')
}
